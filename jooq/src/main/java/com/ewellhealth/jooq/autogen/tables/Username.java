...
public class Username extends TableImpl<UsernameRecord> {
    ...
    private static final long serialVersionUID = -756126598;
    ...
    public <O extends Record> Username(Table<O> child, ForeignKey<O, UsernameRecord> key) {
        super(child, key, USERNAME);
    }
